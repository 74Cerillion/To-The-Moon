...
class GravSys():
    ...
    def sim_loop(self):
        """Loops bodies in a list through time steps."""
...
class Body(Turtle):
    """Celestial object that orbits and has gravitational field"""
...
def main():
    ...
    image_earth = 'Hard/To The Moon/earth_100x100.gif'
    ...
    image_moon = 'Hard/To The Moon/moon_27x27.gif'
